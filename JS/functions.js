 ...
 */
    ...
    if (number == 2) {
        ...
        return (false + " The random number is " + number);
    }
}
...
function applyDiscount (){
    var totalPrice = prompt("Enter the total price...");
    var discountPercent = prompt("Enter the discount percentage...");
    var discountPrice = parseFloat(totalPrice) - (parseFloat(totalPrice) * (parseFloat(discountPercent) / 100));
    return("The discount price is $" + discountPrice.toFixed(2) + " after a discount of " + discountPercent +
        "% was applied to the total of $" + totalPrice + ".");
